        ...
        <Container>
            ...
            <div className="bg-light p-4 rounded">
                ...
                <Row>
                    {myJunk.map((junk) => (
                        <Col key={junk.id}>
                            <EditJunkTile itemObj={junk} targetJunkStateSetterForParent={setTargetJunk} isSelected={targetJunk?.id === junk.id} handleJunkDelete={handleJunkDelete}></EditJunkTile>
                        </Col>
                    ))}
                </Row>
